...
def main():
    ...
    path_content= '/content/drive/My Drive/STSC_2019_12_20/Step_1_data_preprocess/data_normalized_tf'
    paths_data = [path_content + '\\data_normalized_tf_' + str(i) + '.csv' for i in range(6,17)]
    
    all_record_df = pd.DataFrame(columns = [str(float(i/20)) for i in range(5,20)])
    ...
    for path_data in paths_data:
        ...
        print('DecisionTreeClassifier:',max_acc_1,k_1,'\n',
              'RandomForestClassifier:',max_acc_2,k_2,'\n',
              'ExtraTreesClassifier:',max_acc_3,k_3,'\n',
              'SVMClassifiier:',max_acc_4,k_4
              )
...
#            break
    ...
    all_record_df.to_excel(path_D_R_E_S + '/D_R_E_S_tf_6_16.xlsx')
